...
export default function Loader({ onComplete }: { onComplete: () => void }) {
  ...
  const stages = [
    { text: "Loading city grid database...", icon: <Layers className="w-4 h-4 text-brand-teal" /> },
    { text: "Drawing delivery vectors...", icon: <Navigation2 className="w-4 h-4 text-brand-blue" /> },
    { text: "Scanning available locations...", icon: <Compass className="w-4 h-4 text-brand-teal" /> },
    { text: "Optimizing reservation routes...", icon: <Navigation2 className="w-4 h-4 text-brand-blue rotate-45" /> },
    { text: "Ready to reserve.", icon: <CheckCircle2 className="w-4 h-4 text-emerald-500" /> }
  ];
      ...
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none opacity-40">
        ...
        >
          ...
          >
            ...
            <rect x="50" y="50" width="300" height="200" rx="12" fill="#F7F4EF" strokeWidth="0.5" />
            <rect x="380" y="50" width="200" height="350" rx="12" fill="#F7F4EF" strokeWidth="0.5" />
            <rect x="610" y="50" width="540" height="150" rx="12" fill="#F7F4EF" strokeWidth="0.5" />
            <rect x="50" y="280" width="300" height="470" rx="12" fill="#F7F4EF" strokeWidth="0.5" />
            <rect x="380" y="430" width="450" height="320" rx="12" fill="#F7F4EF" strokeWidth="0.5" />
            <rect x="860" y="230" width="290" height="350" rx="12" fill="#F7F4EF" strokeWidth="0.5" />
            <rect x="860" y="600" width="290" height="150" rx="12" fill="#F7F4EF" strokeWidth="0.5" />
            ...
            <motion.path
              ...
              animate={{ strokeDashoffset: progress > 15 ? 600 - (progress - 15) * 7 : 600 }}
            ...
            <motion.path
              ...
              animate={{ strokeDashoffset: progress > 5 ? 800 - (progress - 5) * 9.5 : 800 }}
              transition={{ ease: "linear" }}
            />
          </svg>

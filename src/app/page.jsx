  ...
  useEffect(() => {
    const statsTimer = setInterval(() => {
      ...
      setTotalRevenue(
        (prev) =>
          prev +
          (Math.random() > 0.4 ? Math.floor(Math.random() * 45) + 15 : 0),
      );
  ...
  const mockIntelSpots = [
    {
      ...
      powerGrid: "Yes (50A)",
      description:
        "Waterfront corridor with massive lunch crowds and tourist foot traffic. Ideal for gourmet options.",
    },
    {
      id: 1,
      ...
      powerGrid: "Yes (30A)",
      description:
        "Mid-town plaza flanked by tech offices. Heavy lunch rush from Monday to Thursday.",
    },
    {
      id: 2,
      ...
      powerGrid: "No",
      description:
        "Scenic neighborhood park. Massive weekend crowds, evening family events, and food festivals.",
    },
  ];
    ...
    <div className="w-full flex flex-col bg-brand-warm-white text-brand-navy min-h-screen">
      ...
      <section className="relative pt-32 pb-24 md:pt-40 md:pb-32 overflow-hidden px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto w-full">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-8 text-center lg:text-left">
            ...
            >
              Browse and reserve premium food truck spots with live location
              intelligence, real-time calendars, instant permits, and automated
              payouts. Build your street dining empire on verified data.
            </motion.p>
            ...
            >
              <div className="text-center lg:text-left">
                <span className="block text-[10px] uppercase font-bold tracking-wider text-brand-slate">
                  Active Spots
                </span>
              ...
              <div className="text-center lg:text-left border-x border-brand-navy/10 px-2">
                ...
                <span className="text-xl sm:text-2xl font-extrabold text-brand-teal font-mono">
                  87.4%
                </span>
              </div>
              <div className="text-center lg:text-left">
          ...
          >
            <div className="w-full aspect-square rounded-3xl bg-brand-cream/70 border border-brand-navy/5 shadow-xl relative overflow-hidden flex items-center justify-center p-6">
              ...
              >
                ...
                {/* River */}
                <path
                  d="M-50,420 C180,410 240,250 550,230"
                  stroke="#E0F2FE"
                  strokeWidth="30"
                  strokeLinecap="round"
                />
                ...
                {/* Animated Truck path */}
                <path
                  d="M160,500 L160,160 L340,160 L340,0"
                  stroke="#0D9488"
                  strokeWidth="2"
                  strokeLinecap="round"
                />
              ...
              >
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <span className="block text-[10px] text-brand-slate font-semibold">
                      Gourmet Food Trucks only
                    </span>
                  </div>
                </div>
                <div className="text-right">
                  <span className="block text-[10px] uppercase font-bold text-brand-teal">
                    92% Occupied
                  </span>
                  <span className="block text-xs font-bold text-brand-navy">
                    $1,850/day avg.
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto space-y-4 mb-16">
            ...
            <h2 className="text-3xl sm:text-4xl font-extrabold text-brand-navy">
              Verify high-yield spots before booking
            </h2>
            <p className="text-sm sm:text-base text-brand-slate font-medium">
              We compile cell phone foot traffic, peak hours data, and
              historical sales volumes to grade locations. Select a spot below
              to view its premium metrics.
            </p>
          </div>
            ...
            <div className="lg:col-span-7 bg-white border border-brand-navy/5 rounded-3xl p-6 sm:p-8 flex flex-col justify-between shadow-sm">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                ...
                <div className="aspect-square rounded-2xl bg-brand-cream/50 relative overflow-hidden border border-brand-navy/5">
                  <svg
                    className="w-full h-full text-brand-cream-dark opacity-80"
                    viewBox="0 0 800 800"
                    fill="none"
                    stroke="currentColor"
                  >
                ...
                <div className="space-y-6">
                  <div>
                    <span className="text-xs uppercase font-extrabold text-brand-teal">
                      VERIFIED DATA
                    </span>
                  ...
                  <div className="grid grid-cols-2 gap-4 border-t border-brand-navy/5 pt-4">
                    <div>
                      <span className="block text-[10px] font-bold text-brand-slate uppercase">
                        Foot Traffic
                      </span>
      ...
      <section className="py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="flex flex-col md:flex-row items-start md:items-end justify-between mb-16 gap-6">
          <div className="space-y-4">
            ...
            <h2 className="text-3xl sm:text-4xl font-extrabold text-brand-navy">
              Top food truck spots in high demand
            </h2>
          </div>
          <Link
            href="/marketplace"
            ...
            <div>
              ...
              <div className="p-6 space-y-4">
                ...
                <p className="text-xs text-brand-slate font-medium leading-relaxed">
                  Stunning views, maximum office worker density, and heavy
                  evening commuter paths.
                </p>
              </div>
            </div>
            <div className="p-6 border-t border-brand-navy/5 bg-brand-cream/20 flex items-center justify-between">
              <div>
                <span className="block text-[10px] text-brand-slate font-bold uppercase">
                  DAILY RATE
                </span>
                <span className="text-sm font-extrabold text-brand-navy">
                  $180<span className="text-xs font-normal">/day</span>
                </span>
              </div>
              <Link
            ...
            <div>
              ...
              <div className="p-6 space-y-4">
                <div className="flex justify-between items-start">
                  <div>
                    <h3 className="text-lg font-bold text-brand-navy">
                      Soma Plaza Courtyard
                    </h3>
                    <p className="text-xs text-brand-slate font-medium">
                      Bustling Lunch Market
                    </p>
                  </div>
                  <span className="text-xs font-extrabold text-emerald-500 bg-emerald-500/10 px-2 py-0.5 rounded-full">
                    85% Occupied
                ...
                <p className="text-xs text-brand-slate font-medium leading-relaxed">
                  Surrounded by financial and technology skyscrapers. Heavy
                  traffic Monday through Thursday.
                </p>
              </div>
            </div>
            <div className="p-6 border-t border-brand-navy/5 bg-brand-cream/20 flex items-center justify-between">
              <div>
                ...
                <span className="text-sm font-extrabold text-brand-navy">
                  $220<span className="text-xs font-normal">/day</span>
                </span>
              </div>
              <Link
          ...
          <div className="group rounded-3xl bg-white border border-brand-navy/5 overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 flex flex-col justify-between">
            <div>
              ...
              <div className="p-6 space-y-4">
                ...
                <p className="text-xs text-brand-slate font-medium leading-relaxed">
                  Best suited for weekends, evening picnics, family dinners,
                  dessert trucks and cafes.
                </p>
              </div>
            </div>
            <div className="p-6 border-t border-brand-navy/5 bg-brand-cream/20 flex items-center justify-between">
              <div>
                ...
                <span className="text-sm font-extrabold text-brand-navy">
                  $110<span className="text-xs font-normal">/day</span>
                </span>
              </div>
              <Link
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-6">
              ...
              <p className="text-sm text-slate-300 font-medium leading-relaxed">
                Check exact spot availability instantly. Our calendar lets
                owners filter by morning, evening, or full-day shifts. Click
                directly on available dates to initiate booking.
              </p>
            ...
            <div className="space-y-6">
              ...
              <p className="text-sm text-slate-300 font-medium leading-relaxed">
                SpotReserve provides a live dashboard reporting daily revenue
                metrics, customer counts, and electrical grid consumption.
                Manage payout transfers instantly.
              </p>
              ...
              <div className="p-6 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-md space-y-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <span className="text-2xl font-extrabold font-mono text-brand-teal">
                      $14,850.40
                    </span>
                  </div>
                ...
                <div className="h-32 flex items-end justify-between gap-3 pt-4 border-t border-white/10">
                  {[45, 60, 52, 78, 85, 95, 70].map((height, idx) => {
                    ...
                    return (
                      ...
                      >
                        <div
                          className="w-full bg-white/5 hover:bg-brand-teal/20 rounded-t-md relative overflow-hidden transition-colors"
                          style={{ height: "90px" }}
                        >
                          <motion.div
                            initial={{ height: 0 }}
      ...
      <section className="py-24 bg-brand-warm-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto space-y-4 mb-20">
            ...
            <h2 className="text-3xl sm:text-4xl font-extrabold text-brand-navy">
              How SpotReserve Works
            </h2>
            <p className="text-sm sm:text-base text-brand-slate font-medium">
              Seamlessly browse, permit, book, and transact. We handle all
              logistics under the hood.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 relative">
            ...
            <div className="relative space-y-4 flex flex-col items-center text-center">
              ...
              <p className="text-xs text-brand-slate font-medium max-w-xs leading-relaxed">
                Filter coordinates by city borough, power configurations,
                historical sales grades, and price points.
              </p>
            </div>
            ...
            <div className="relative space-y-4 flex flex-col items-center text-center">
              ...
              <p className="text-xs text-brand-slate font-medium max-w-xs leading-relaxed">
                Choose custom slots (Morning lunch blocks, evening dinner
                blocks, or 24h reservations) directly on our interactive
                calendar.
              </p>
            </div>
            ...
            <div className="relative space-y-4 flex flex-col items-center text-center">
              ...
              <h3 className="text-lg font-bold text-brand-navy">
                Simulated Stripe Pay
              </h3>
              <p className="text-xs text-brand-slate font-medium max-w-xs leading-relaxed">
                Confirm bookings with modern card details. Permits,
                certificates, and compliance check out instantly.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
            <div className="lg:col-span-5 space-y-6">
              ...
              <p className="text-sm text-brand-slate font-medium leading-relaxed">
                Running multiple trucks? Manage your entire crew, monitor
                schedules, review weekly financial charts, download tax
                receipts, and access support tickets inside a streamlined
                interface.
              </p>
              ...
              <div className="space-y-3 pt-2">
                ...
                <div className="flex items-center space-x-2 text-xs font-semibold text-brand-navy">
                  <Check className="w-4 h-4 text-brand-teal shrink-0" />
                  <span>
                    Crew invite system with detailed permissions control.
                  </span>
                </div>
                <div className="flex items-center space-x-2 text-xs font-semibold text-brand-navy">
                  <Check className="w-4 h-4 text-brand-teal shrink-0" />
                  <span>
                    Support Center featuring live ticketing and settings
                    configuration.
                  </span>
                </div>
              </div>
            ...
            <div className="lg:col-span-7 bg-brand-navy rounded-3xl p-6 shadow-2xl relative overflow-hidden">
              ...
              <div className="p-5 rounded-xl bg-white/5 border border-white/15 space-y-4">
                <div className="flex items-center justify-between text-xs text-slate-300 font-bold">
                  ...
                  <span className="text-[10px] text-brand-teal font-mono">
                    82% Capacity
                  </span>
                </div>
                <div className="h-24 flex items-end justify-between gap-2">
                  {[20, 35, 40, 30, 65, 80, 50, 45, 60, 70, 85, 90].map(
                    (h, i) => (
                      <div
                        key={i}
                        className="flex-grow bg-white/10 rounded-t-sm h-full relative"
                      >
                        <div
      ...
      <section className="py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="text-center max-w-3xl mx-auto space-y-4 mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl font-extrabold text-brand-navy">
            Transparent, growth-focused pricing
          </h2>
          <p className="text-sm sm:text-base text-brand-slate font-medium">
            Choose the tier matching your truck fleet size. Toggle annual
            billing to save 20%.
          </p>
            ...
            <button
              ...
              className={`px-4 py-2 rounded-full text-xs font-bold uppercase tracking-wider transition-all ${
                billingPeriod === "monthly"
                  ? "bg-brand-navy text-brand-warm-white shadow-md"
                  : "text-brand-slate"
              }`}
            >
              Monthly
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="p-8 rounded-3xl bg-white border border-brand-navy/5 flex flex-col justify-between shadow-sm hover:border-brand-navy/15 transition-all">
            <div className="space-y-6">
              <div>
                <span className="text-xs font-bold uppercase text-brand-slate tracking-wider">
                  Starter Spot
                </span>
                ...
                <p className="text-xs text-brand-slate font-medium mt-2">
                  Perfect for single food truck operators.
                </p>
              </div>
          ...
          <div className="p-8 rounded-3xl bg-brand-navy text-brand-warm-white flex flex-col justify-between shadow-xl relative overflow-hidden border border-white/5">
            ...
            <div className="space-y-6">
              <div>
                <span className="text-xs font-bold uppercase text-brand-teal tracking-wider">
                  Fleet Premium
                </span>
                ...
                <p className="text-xs text-slate-300 font-medium mt-2">
                  Ideal for operators running 2-5 food trucks.
                </p>
              </div>
          ...
          <div className="p-8 rounded-3xl bg-white border border-brand-navy/5 flex flex-col justify-between shadow-sm hover:border-brand-navy/15 transition-all">
            <div className="space-y-6">
              <div>
                ...
                <p className="text-xs text-brand-slate font-medium mt-2">
                  For large hospitality fleets & franchises.
                </p>
              </div>
      ...
      <section className="py-24 bg-brand-cream/30 border-y border-brand-navy/5 w-full">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          <div className="text-center max-w-3xl mx-auto space-y-4 mb-16">
            ...
            <h2 className="text-3xl sm:text-4xl font-extrabold text-brand-navy">
              Loved by premium street vendors
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {testimonials.map((t, idx) => (
              <div
                key={idx}
                className="p-6 rounded-3xl bg-white border border-brand-navy/5 shadow-sm space-y-6 flex flex-col justify-between"
              >
                <div className="space-y-4">
                  {/* Stars */}
        ...
        <div className="bg-brand-navy text-brand-warm-white rounded-3xl p-8 sm:p-12 relative overflow-hidden border border-white/10 shadow-2xl space-y-8">
          ...
          <div className="max-w-2xl mx-auto space-y-4">
            ...
            <p className="text-xs sm:text-sm text-slate-300 font-medium">
              Join thousands of food truck owners building sustainable dining
              streams with SpotReserve.
            </p>
          </div>
      ...
      <footer className="bg-brand-cream/40 border-t border-brand-navy/5 pt-16 pb-12 px-4 sm:px-6 lg:px-8 w-full mt-auto">
        <div className="max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-5 gap-8 border-b border-brand-navy/5 pb-12">
          ...
          <div className="col-span-2 space-y-4">
            ...
            <p className="text-xs text-brand-slate max-w-sm font-medium leading-relaxed">
              SpotReserve provides verified location logistics, reservation
              calendars, permits compliance, and revenue reporting systems for
              next-generation street dining groups.
            </p>
          </div>

          {/* Platform column */}
          <div>
            <span className="block text-xs font-bold uppercase tracking-wider text-brand-navy mb-4 font-mono">
              Platform
            </span>
            <ul className="space-y-2.5 text-xs text-brand-slate font-medium">
              <li>
                <Link href="/marketplace" className="hover:text-brand-teal">
                  Spots Marketplace
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/walkthrough" className="hover:text-brand-teal">
                  Demo Walkthrough
                </Link>
              </li>
              <li>
                <Link href="/dashboard" className="hover:text-brand-teal">
                  Truck Owner Portal
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-xs text-brand-slate font-medium">
              ...
              <li>
                <Link href="/help" className="hover:text-brand-teal">
                  Help & FAQ
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-xs text-brand-slate font-medium">
              ...
              <li>
                <Link href="/support" className="hover:text-brand-teal">
                  Support Help Desk
                </Link>
              </li>
              <li>
                <Link href="/settings" className="hover:text-brand-teal">
                  Settings
                </Link>
              </li>
            </ul>
        ...
        <div className="max-w-7xl mx-auto pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-[10px] text-brand-slate font-medium uppercase tracking-wider">
          <span>
            &copy; {new Date().getFullYear()} SpotReserve Inc. All rights
            reserved.
          </span>

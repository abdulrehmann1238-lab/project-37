...
export default function ReservationWizardPage({ params }: { params: Promise<{ id: string }> }) {
  const { id } = use(params);
  ...
  const spotName = id === "soma-plaza" ? "Soma Plaza Courtyard" : "Pier 14 Water Terminal";
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        ...
        <div className="bg-brand-cream/40 border border-brand-navy/5 p-4 rounded-2xl shadow-sm">
          <div className="flex justify-between text-[10px] text-brand-slate font-bold uppercase tracking-wider font-mono mb-2">
            ...
            <span className="text-brand-teal">{stepNames[currentStep - 1]}</span>
          </div>
            ...
            >
              ...
              {currentStep === 1 && (
                <div className="space-y-4">
                  ...
                  <h2 className="text-2xl font-extrabold text-brand-navy">Confirm target reservation spot</h2>
                  ...
                  <div className="p-5 rounded-2xl bg-brand-cream/40 border border-brand-navy/5 flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <h4 className="text-base font-extrabold text-brand-navy mt-1">{spotName}</h4>
                      <p className="text-[10px] text-brand-slate font-medium">Zone A Corridor • San Francisco</p>
                    </div>
                  </div>
                </div>
              )}
              ...
              {currentStep === 2 && (
                <div className="space-y-4">
                  ...
                  <h2 className="text-2xl font-extrabold text-brand-navy">Confirm booking date</h2>
                  <p className="text-xs text-brand-slate font-semibold">
                    Verify date slot compatibility. Dates are checked live for city permitting schedules.
                  </p>
                  ...
                  <div className="p-5 rounded-2xl bg-brand-cream/40 border border-brand-navy/5 flex items-center space-x-4">
                    ...
                    <div>
                      <span className="block text-[10px] font-bold text-brand-slate uppercase font-mono">SELECTED DATE</span>
              ...
              {currentStep === 3 && (
                <div className="space-y-4">
                  ...
                  <h2 className="text-2xl font-extrabold text-brand-navy">Confirm shift slot</h2>
                  <p className="text-xs text-brand-slate font-semibold">
                    Standard lunch and dinner blocks help coordinate peak delivery corridors.
                  </p>
                  ...
                  <div className="p-5 rounded-2xl bg-brand-cream/40 border border-brand-navy/5 flex items-center space-x-4">
                    ...
                    <div>
                      <span className="block text-[10px] font-bold text-brand-slate uppercase font-mono">RESERVED SHIFT</span>
                      <h4 className="text-lg font-extrabold text-brand-navy mt-1">{getShiftLabel()}</h4>
                      <p className="text-[10px] text-brand-slate font-medium">Daily spot rate: ${getPrice()}/shift</p>
                    </div>
                  </div>
                </div>
              )}
              ...
              {currentStep === 4 && (
                <div className="space-y-4">
                  ...
                  <h2 className="text-2xl font-extrabold text-brand-navy">Business registration</h2>
                  <p className="text-xs text-brand-slate font-semibold mb-4">
                    Provide food truck registration and license credentials for municipal audit logs.
                  </p>

                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-1">
                      <label className="block text-[10px] font-bold text-brand-slate uppercase font-mono">Truck / Brand Name</label>
                      <input
                        type="text"
                        value={truckName}
                    ...
                    <div className="space-y-1">
                      <label className="block text-[10px] font-bold text-brand-slate uppercase font-mono">Cuisine Category</label>
                      <input
                        type="text"
                        value={cuisineType}
                    ...
                    <div className="space-y-1">
                      <label className="block text-[10px] font-bold text-brand-slate uppercase font-mono">Truck Length (Max 32ft)</label>
                      <input
                        type="text"
                        value={truckLength}
                    ...
                    <div className="space-y-1">
                      <label className="block text-[10px] font-bold text-brand-slate uppercase font-mono">Permit License Number</label>
                      <input
                        type="text"
                        value={permitLicense}
              ...
              {currentStep === 5 && (
                <div className="space-y-4">
                  ...
                  <h2 className="text-2xl font-extrabold text-brand-navy">Review booking details</h2>
                  <p className="text-xs text-brand-slate font-semibold mb-4">
                    Please verify spot selection, shifts, and business information before checking out.
                  </p>
                  ...
                  <div className="bg-brand-cream/35 border border-brand-navy/5 rounded-2xl p-5 space-y-3 text-xs text-brand-slate font-semibold">
                    <div className="flex justify-between border-b border-brand-navy/5 pb-2">
                      ...
                      <span className="text-brand-navy font-extrabold">{spotName}</span>
                    </div>
                    <div className="flex justify-between border-b border-brand-navy/5 pb-2">
                      <span>Date</span>
                      <span className="text-brand-navy font-extrabold">{selectedDate}</span>
                    </div>
                    <div className="flex justify-between border-b border-brand-navy/5 pb-2">
                      <span>Shift</span>
                      <span className="text-brand-navy font-extrabold">{getShiftLabel()}</span>
                    </div>
                    <div className="flex justify-between border-b border-brand-navy/5 pb-2">
                      <span>Truck Brand</span>
                      <span className="text-brand-navy font-extrabold">{truckName}</span>
                    </div>
              ...
              {currentStep === 6 && (
                <div className="space-y-4">
                  ...
                  <h2 className="text-2xl font-extrabold text-brand-navy">Simulate credit card payment</h2>
                  <p className="text-xs text-brand-slate font-semibold">
                    Use any card details for checkout. No actual money will be charged.
                  </p>
                  ...
                  <div className="p-6 rounded-2xl bg-brand-navy text-brand-warm-white space-y-6 shadow-xl relative overflow-hidden border border-white/10">
                    ...
                    <div className="flex justify-between items-center">
                      <div className="flex items-center space-x-2">
                        ...
                        <span className="text-xs font-bold tracking-widest font-mono">SpotReserve Payout</span>
                      </div>
                    ...
                    <div className="space-y-4 relative z-10">
                      <div className="space-y-1">
                        <label className="block text-[8px] font-bold text-slate-400 uppercase tracking-widwider font-mono">Card Number</label>
                        <input
                          type="text"
                          value={cardNumber}
                      ...
                      <div className="grid grid-cols-3 gap-4">
                        <div className="col-span-1 space-y-1">
                          <label className="block text-[8px] font-bold text-slate-400 uppercase tracking-widwider font-mono">Expiry</label>
                          <input
                            type="text"
                            value={cardExpiry}
                        ...
                        <div className="col-span-1 space-y-1">
                          <label className="block text-[8px] font-bold text-slate-400 uppercase tracking-widwider font-mono">CVC</label>
                          <input
                            type="text"
                            value={cardCvc}
                        ...
                        <div className="col-span-1 space-y-1">
                          <label className="block text-[8px] font-bold text-slate-400 uppercase tracking-widwider font-mono">ZIP Code</label>
                          <input
                            type="text"
                            value={cardZip}
                  ...
                  <div className="flex items-start space-x-2 text-[10px] text-brand-slate font-medium bg-brand-cream/40 p-3 rounded-xl border border-brand-navy/5">
                    ...
                    <span>Payment simulates a secured Stripe transaction. Direct bank transfers are optimized upon completion.</span>
                  </div>
                </div>
              )}
              ...
              {currentStep === 7 && (
                <div className="space-y-6 flex flex-col items-center justify-center text-center">
                  ...
                  <div className="space-y-2 max-w-sm">
                    ...
                    <h2 className="text-2xl font-extrabold text-brand-navy">Reservation Successful!</h2>
                    <p className="text-xs text-brand-slate font-semibold">
                      Your location spot has been booked. City municipal permits are authorized and signed.
                    </p>
                  </div>
                  ...
                  <div className="w-full bg-brand-cream/35 border border-brand-navy/5 rounded-2xl p-5 space-y-4 text-left max-w-md">
                    <div className="flex justify-between border-b border-brand-navy/10 pb-3">
                      <div>
                        <span className="block text-[8px] text-brand-slate font-bold uppercase font-mono">BOOKING REFERENCE</span>
                        <span className="text-sm font-extrabold text-brand-navy font-mono">SR-6092-B14</span>
                      </div>
                      <div className="text-right">
                        <span className="block text-[8px] text-brand-slate font-bold uppercase font-mono">STATUS</span>
                    ...
                    <div className="grid grid-cols-2 gap-4 text-xs font-semibold text-brand-slate">
                      <div>
                        <span className="block text-[8px] font-bold uppercase font-mono">Spot Location</span>
                        <span className="text-brand-navy font-bold">{spotName}</span>
                      </div>
                      <div>
                        <span className="block text-[8px] font-bold uppercase font-mono">Shift Block</span>
                        <span className="text-brand-navy font-bold">{selectedShift === "full" ? "Full-Day" : selectedShift === "evening" ? "Dinner" : "Lunch"}</span>
                      </div>
                      <div>
                        <span className="block text-[8px] font-bold uppercase font-mono">Date</span>
                        <span className="text-brand-navy font-bold">{selectedDate}</span>
                      </div>
                      <div>
                        <span className="block text-[8px] font-bold uppercase font-mono">Operator</span>
                        <span className="text-brand-navy font-bold">{truckName}</span>
                      </div>
                    </div>
                    ...
                    <div className="border-t border-brand-navy/10 pt-4 flex items-center justify-between">
                      <div className="w-16 h-16 bg-white border border-brand-navy/10 p-1 rounded-lg flex items-center justify-center shrink-0">
                        {/* Styled QR Block SVG */}
                        <svg className="w-full h-full text-brand-navy" viewBox="0 0 100 100" fill="currentColor">
                      ...
                      <div className="text-right">
                        <span className="block text-[8px] text-brand-slate font-bold uppercase font-mono">PAID AMOUNT</span>
                        <span className="text-lg font-extrabold text-brand-teal font-mono">${(getPrice() + 15).toFixed(2)}</span>
                        <span className="block text-[8px] text-brand-slate font-semibold mt-1">Receipt emailed to owner</span>
                      </div>
                    </div>
                  </div>
                </div>

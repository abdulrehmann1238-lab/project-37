...
export default function HelpCenterPage() {
  ...
  const articles = [
    {
      title: "How do I download my municipal permit tag?",
      cat: "permits",
      desc: "Permits are generated automatically upon successful checkout. You can print them under Dashboard > Upcoming.",
    },
    {
      title: "When do location payout deposits settle?",
      cat: "payouts",
      desc: "For Starter plans, payouts clear in 3-5 days. Premium and Enterprise plans support next-day or instant transfers.",
    },
    {
      title: "What electrical hookups are available at Pier 14?",
      cat: "utilities",
      desc: "Pier 14 provides 50A utility grid outlets. Soma Plaza Courtyard provides 30A outlets. Generators are required elsewhere.",
    },
    {
      title: "How do I cancel a scheduled spot reservation?",
      cat: "permits",
      desc: "Select 'Cancel Booking' inside Dashboard > Upcoming. Cancellations made 48h prior receive a 100% platform refund.",
    },
  ];
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        <div className="text-center space-y-4">
          ...
          <h1 className="text-4xl sm:text-5xl font-extrabold tracking-tight">
            Help Center & FAQ Desk
          </h1>
          <p className="text-sm sm:text-base text-brand-slate font-medium max-w-xl mx-auto">
            Search documented guides on zoning, utility grid hookups, invoice
            billing, and direct bank payouts.
          </p>
        </div>
        ...
        <div className="p-6 rounded-3xl bg-brand-cream/40 border border-brand-navy/5 shadow-sm text-center space-y-4">
          <div>
            ...
            <span className="block text-[11px] text-brand-slate font-medium mt-1">
              Create a support ticket to chat directly with a live SpotReserve
              zoning specialist.
            </span>
          </div>
          <Link

...
import { Search, MapPin, Truck, Calendar, Trash2 } from "lucide-react";
...
export default function AdminReservations() {
  ...
  const [bookings, setBookings] = useState([
    {
      id: "SR-6092-B14",
      truck: "Fire & Slice Pizza",
      spot: "Pier 14 Water Terminal",
      date: "June 12, 2026",
      shift: "Lunch",
      amount: "$195.00",
      status: "Active",
    ...
    {
      id: "SR-8104-A9",
      truck: "Taco Loco Express",
      spot: "Soma Plaza Courtyard",
      date: "June 15, 2026",
      shift: "Dinner",
      amount: "$235.00",
      status: "Active",
    ...
    <div className="p-6 space-y-8">
      ...
      <div>
        ...
        <p className="text-xs text-brand-slate font-medium font-sans">
          Audit real-time spot occupancy logs, track operator permits, and
          coordinate check-in codes.
        </p>
      </div>

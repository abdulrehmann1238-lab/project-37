...
import { Landmark as BankIcon, Save, ShieldCheck } from "lucide-react";
...
export default function AdminRevenue() {
  ...
  const cards = [
    {
      label: "SaaS Gross Merchandise Value (GMV)",
      value: "$104,820.50",
      change: "+18.4% MoM",
      desc: "Across all active spots",
    },
    {
      label: "Platform Take-Rate (Commission)",
      value: "$15,723.07",
      change: `${takeRate}% Config.`,
      desc: "SpotReserve platform cut",
    },
    {
      label: "Total Paid Out to Operators",
      value: "$89,097.43",
      change: "98.2% settled",
      desc: "Chase Automated Payouts",
    },
    {
      label: "Pending Payout settlements",
      value: "$1,625.50",
      change: "Standard 24h",
      desc: "Awaiting next banking cycle",
    },
  ];
  ...
  const payouts = [
    ...
    {
      id: "PAY-8821",
      operator: "Taco Loco Express",
      bank: "Wells Fargo checking (*0821)",
      amount: "$1,640.00",
      date: "June 4, 2026",
      status: "Settled",
    },
    {
      id: "PAY-7038",
      operator: "Green Garden Bowls",
      bank: "BofA checking (*9401)",
      amount: "$908.17",
      date: "May 28, 2026",
      status: "Settled",
    },
    ...
    <div className="p-6 space-y-8">
      ...
      <div>
        <h1 className="text-2xl font-extrabold tracking-tight text-brand-navy">
          Revenue Reports & Platform Fees
        </h1>
        <p className="text-xs text-brand-slate font-medium font-sans">
          Audit platform-wide transaction invoices, configure take-rate
          commissions, and review payout settlement logs.
        </p>
      </div>
      ...
      {savedAlert && (
        <div className="p-4 rounded-2xl bg-emerald-500/10 border border-emerald-500/20 text-emerald-500 text-xs font-bold flex items-center space-x-2 shadow-sm">
          ...
          <span>
            Platform Commission configurations updated! Real-time checks sync
            with checkout portals.
          </span>
        </div>
      )}
          ...
          <form onSubmit={handleSaveConfig} className="space-y-4">
            <div className="space-y-1">
              ...
              <div className="relative">
                ...
                <span className="absolute right-4 top-1/2 -translate-y-1/2 text-xs font-bold text-brand-slate font-mono">
                  %
                </span>
              </div>
            </div>

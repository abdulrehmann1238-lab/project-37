...
export default function DashboardOverview() {
  const stats = [
    {
      name: "Monthly Revenue Proj.",
      value: "$14,820.00",
      change: "+14.8%",
      color: "text-brand-teal",
    },
    {
      name: "Active Reserved spots",
      value: "3 Locations",
      change: "Current Week",
  ...
  const insights = [
    {
      title: "Downtown corridor spike",
      text: "Evening food traffic at Pier 14 is up 22%. We recommend checking next week's availability.",
      icon: <Sparkles className="w-4 h-4 text-amber-500" />,
    },
    {
      title: "Soma electrical maintenance",
      text: "Electrical grid hookups will undergo standard municipal audits next Friday. Prepare generators.",
    ...
    <div className="p-6 space-y-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-brand-slate font-medium">
            Here’s how your food truck operations are performing this week.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <span className="text-[10px] text-brand-slate font-medium">
                Aggregated across all active food truck bays
              </span>
            </div>
        ...
        <div className="lg:col-span-4 p-5 sm:p-6 rounded-3xl bg-white border border-brand-navy/5 shadow-sm flex flex-col justify-between space-y-4">
          <div>
            <span className="block text-xs font-bold text-brand-navy uppercase font-mono mb-4">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between text-xs pb-3 border-b border-brand-navy/5">
                ...
                <span className="font-extrabold text-brand-teal font-mono">
                  $1,850/day
                </span>
              </div>
              <div className="flex items-center justify-between text-xs pb-3 border-b border-brand-navy/5">
        ...
        <div className="lg:col-span-7 p-5 sm:p-6 rounded-3xl bg-white border border-brand-navy/5 shadow-sm space-y-4">
          <div className="flex justify-between items-center mb-2">
            <span className="text-xs font-bold text-brand-navy uppercase font-mono">
              Upcoming Scheduled Spots
            </span>
            <Link
              href="/dashboard/upcoming"
              className="text-[10px] text-brand-teal hover:underline font-bold font-mono"
            >
              View Calendar
            </Link>
          </div>

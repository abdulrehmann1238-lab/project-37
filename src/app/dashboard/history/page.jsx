    ...
    <div className="p-6 space-y-8">
      <div>
        ...
        <p className="text-xs text-brand-slate font-medium">
          Browse historical reservation payouts, transaction statements, and
              ...
              {filteredHistory.length > 0 ? (
                filteredHistory.map((item) => {
                  ...
                  if (item.status === "Cancelled")
                    statusBadge = "text-rose-500 bg-rose-500/10";
                  if (item.status === "Expired")
                    statusBadge = "text-slate-400 bg-slate-100";
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="px-6 py-4 font-mono text-brand-navy font-bold">
                        {item.amount}
                      </td>
                ...
                <tr>
                  <td
                    colSpan={7}
                    className="px-6 py-12 text-center text-brand-slate"
                  >

    ...
    <div className="p-6 space-y-8">
      <div>
        ...
        <p className="text-xs text-brand-slate font-medium">
          Verify permits and configure scheduling details for upcoming location
          assignments.
        </p>
      </div>
      ...
      <div className="space-y-4">
        {bookings.length > 0 ? (
              ...
              <div className="space-y-4 flex-1">
                ...
                <div className="flex space-x-4 border-t border-brand-navy/5 pt-4 text-xs font-medium text-brand-slate">
                  ...
                  <div>
                    ...
                    <span className="text-brand-navy font-semibold font-mono">
                      {booking.rate}
                    </span>
                  </div>
                </div>
          ...
          <div className="text-center py-20 bg-white border border-brand-navy/5 rounded-3xl space-y-4">
            <span className="text-xs text-brand-slate font-semibold block">
      ...
      <div className="p-4 rounded-2xl bg-brand-cream/40 border border-brand-navy/5 flex items-start space-x-3 text-xs font-semibold text-brand-slate shadow-sm">
        ...
        <div>
          ...
          <span className="block text-[10px] text-brand-slate font-medium leading-relaxed mt-0.5">
            Cancellations made more than 48 hours prior to the reserved shift
            slot are eligible for a 100% platform credit refund. Late
            cancellations are charged a 30% retention fee for city zoning holds.
          </span>
        </div>
      </div>
    </div>

      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4">
          ...
          <h1 className="text-4xl sm:text-5xl font-extrabold tracking-tight">
            Flexible plans for food truck operators
          </h1>
          <p className="text-sm sm:text-base text-brand-slate font-medium">
            Choose the plan that matches your truck capacity. Save 20% by
            subscribing to annual billing.
          </p>
          ...
          {plans.map((plan, idx) => (
            ...
            >
              ...
              <div className="space-y-6">
                <div>
                  <span
                    className={`text-xs font-bold uppercase tracking-wider ${plan.recommended ? "text-brand-teal" : "text-brand-slate"}`}
                  >
                    {plan.name}
                  </span>
                  <div className="flex items-baseline space-x-1 mt-3">
                    ...
                    <span
                      className={`text-xs ${plan.recommended ? "text-slate-400" : "text-brand-slate"}`}
                    >
                      /mo
                    </span>
                  </div>
                  <p
                    className={`text-xs font-medium mt-2 leading-relaxed ${plan.recommended ? "text-slate-300" : "text-brand-slate"}`}
                  >
                    {plan.desc}
                  </p>
                </div>
                ...
                <div
                  className={`border-t pt-6 space-y-3.5 ${plan.recommended ? "border-white/10" : "border-brand-navy/5"}`}
                >
                  {plan.features.map((feature, fIdx) => (
                    <div
                      key={fIdx}
                      className="flex items-start space-x-2.5 text-xs font-semibold"
                    >
        ...
        <div className="max-w-4xl mx-auto space-y-8 border-t border-brand-navy/5 pt-16">
          <h3 className="text-2xl font-extrabold text-brand-navy text-center">
            Frequently Asked Questions
          </h3>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-xs font-semibold text-brand-slate">
            <div className="space-y-2">
              <h4 className="text-brand-navy font-bold">
                Are city permitting fees included in the subscription?
              </h4>
              <p className="leading-relaxed font-medium">
                No, city permitting and parking fees are charged per shift
                reserved, depending on the location grade. The subscription
                covers booking queue access, location intelligence reports,
                next-day payout transfers, and automated scheduling dashboards.
              </p>
            </div>
            <div className="space-y-2">
              <h4 className="text-brand-navy font-bold">
                Can I switch plans or cancel mid-subscription?
              </h4>
              <p className="leading-relaxed font-medium">
                Yes, you can upgrade, downgrade, or cancel your active plan at
                any time inside your Profile settings page. Changes take effect
                on the next billing statement period.
              </p>
            </div>
          </div>
        </div>

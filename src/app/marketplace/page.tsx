...
const mockLocations: LocationItem[] = [
  {
    ...
    reviewsCount: 38,
    coords: { x: 250, y: 180 },
    description: "Flanked by beautiful waterfront paths and skyscraper office exits. Extremely heavy evening traffic.",
  ...
  },
  {
    ...
    reviewsCount: 47,
    coords: { x: 580, y: 220 },
    description: "Located in the heart of tech offices. Premium lunch spot with quick rushes.",
  ...
  },
  {
    ...
    reviewsCount: 22,
    coords: { x: 380, y: 480 },
    description: "Scenic neighborhood park. Heavy weekend family traffic and dining events.",
  ...
  },
  {
    ...
    reviewsCount: 54,
    coords: { x: 650, y: 390 },
    description: "Broadway retail corridor. High student and theatre crowd foot traffic late into the evening.",
  ...
  },
  {
    ...
    reviewsCount: 19,
    coords: { x: 180, y: 620 },
    description: "Beachfront view. High summer tourist volume, perfect for weekend brunch or dessert options.",
  ...
  },
  {
    ...
    reviewsCount: 31,
    coords: { x: 720, y: 150 },
    description: "Corporate campus green space. Steady lunchtime volume Tuesday to Thursday.",
...
export default function MarketplacePage() {
  ...
  const [viewMode, setViewMode] = useState<"list" | "map">("list"); // Mobile toggling
      ...
      <div className="flex-grow flex overflow-hidden relative">
        ...
        >
          ...
          <div className="flex items-center justify-between pb-2 border-b border-brand-navy/5">
            ...
            <div className="flex items-center space-x-2 text-xs">
              <span className="text-brand-slate font-medium">Max Daily Rate:</span>
              <span className="font-extrabold text-brand-navy font-mono">${maxPrice}</span>
              <input
                type="range"
                min="100"
                max="250"
          ...
          {filteredLocations.length > 0 ? (
                ...
                return (
                  ...
                  >
                    <div className="space-y-3">
                      ...
                      <div className="flex items-start justify-between gap-4">
                        ...
                        <div className="flex items-center space-x-1 text-xs shrink-0">
                          ...
                          <span className="font-bold text-brand-navy">{loc.rating}</span>
                    ...
                    <div className="flex items-center justify-between border-t border-brand-navy/5 mt-5 pt-3.5 bg-white">
                      <div>
                        <span className="block text-[8px] font-bold text-brand-slate uppercase">DAILY RATE</span>
                        <span className="text-sm font-extrabold text-brand-navy font-mono">
                          ${loc.price}
                          <span className="text-[10px] font-normal text-brand-slate">/day</span>
                        </span>
                      </div>
            ...
            <div className="text-center py-20 text-brand-slate text-xs space-y-2">
              <span className="block font-bold">No available spots matched filters.</span>
              <span>Try increasing the price slider or checking another category.</span>
            </div>
          )}
        </div>
        ...
        >
          ...
          <div className="w-full h-full max-w-4xl max-h-[750px] relative rounded-3xl overflow-hidden border border-brand-navy/5 bg-brand-cream/65 shadow-inner flex items-center justify-center">
            ...
            >
              {/* Grid Roads */}
              <path d="M200,0 L200,800" strokeDasharray="6 6" className="text-brand-slate/15" />
              <path d="M400,0 L400,800" strokeDasharray="6 6" className="text-brand-slate/15" />
              <path d="M600,0 L600,800" strokeDasharray="6 6" className="text-brand-slate/15" />
              <path d="M800,0 L800,800" strokeDasharray="6 6" className="text-brand-slate/15" />
              <path d="M0,200 L1000,200" strokeDasharray="6 6" className="text-brand-slate/15" />
              <path d="M0,400 L1000,400" strokeDasharray="6 6" className="text-brand-slate/15" />
              <path d="M0,600 L1000,600" strokeDasharray="6 6" className="text-brand-slate/15" />
              ...
              {/* Central Park block */}
              <rect x="250" y="250" width="300" height="200" rx="16" fill="#F0FDF4" stroke="#DCFCE7" strokeWidth="1" />
            </svg>
                ...
                >
                  <span
                    className={`absolute inline-flex h-12 w-12 rounded-full transform -translate-x-1/2 -translate-y-1/2 -top-1/2 -left-1/2 transition-colors ${
                      isActive ? "bg-brand-teal/25 pulse-ring" : "bg-transparent"
                    }`}
                  ></span>
                  <div
              ...
              {activeDetailSpot && (
                ...
                >
                  <div className="flex items-center space-x-3.5">
                    ...
                    <div>
                      <div className="flex items-center space-x-2">
                        <h4 className="text-sm font-extrabold text-brand-navy">{activeDetailSpot.name}</h4>
                  ...
                  <div className="flex sm:flex-col items-center sm:items-end gap-3 sm:gap-1.5 shrink-0 w-full sm:w-auto pt-3 sm:pt-0 border-t sm:border-t-0 border-brand-navy/5">
                    <div>
                      <span className="block text-[8px] text-brand-slate font-bold uppercase sm:text-right">DAILY RATE</span>
                      <span className="text-sm font-extrabold text-brand-navy font-mono">

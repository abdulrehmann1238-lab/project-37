...
const mockDetails = {
  "pier-14": {
    ...
    coords: { x: 250, y: 180 },
    description:
      "Nestled along the main waterfront corridor, Pier 14 connects major corporate headquarters with ferry terminals. It attracts an exceptional lunch rush from Monday to Friday, followed by solid evening crowds looking for gourmet dining before boarding.",
    amenities: [
      {
        name: "50A Electrical Hookup",
        icon: <Zap className="w-4 h-4 text-brand-teal" />,
      },
      {
        name: "WiFi Hotspot (SpotNet)",
        icon: <Wifi className="w-4 h-4 text-brand-teal" />,
      },
      {
        name: "Trash Valet & Recycle",
        icon: <Trash2 className="w-4 h-4 text-brand-teal" />,
      },
      {
        name: "24/7 Security Patrols",
        icon: <ShieldCheck className="w-4 h-4 text-brand-teal" />,
      },
    ],
    ...
    reviews: [
      {
        ...
        date: "June 2, 2026",
        content:
          "Absolutely the best spot in our portfolio. The lunch rush from the financial towers next door is like clockwork. Hooking up to the 50A grid is simple and saves us $30/day in generator fuel!",
      },
      {
        ...
        date: "May 28, 2026",
        content:
          "Very high foot traffic, and the SpotReserve app check-in is seamless. Payouts arrive in our bank account the next morning without issues.",
      },
    ],
  },
};
    ...
    <div className="pt-28 pb-20 bg-brand-warm-white text-brand-navy min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        ...
        <div className="flex items-center space-x-2 text-xs font-semibold text-brand-slate uppercase font-mono">
          <Link
            href="/marketplace"
            className="hover:text-brand-teal flex items-center space-x-1"
          >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-8 space-y-10">
            ...
            <div className="space-y-6 border-t border-brand-navy/5 pt-8">
              <h3 className="text-xl font-bold text-brand-navy">
                Historical Performance & Traffic
              </h3>
              <p className="text-xs text-brand-slate font-medium">
                Review historical weekly customer metrics and hourly traffic
                distribution below to estimate menu logistics.
              </p>
                ...
                <div className="p-5 rounded-2xl bg-white border border-brand-navy/5 shadow-sm">
                  ...
                  <div className="h-44 flex items-end justify-between gap-2 pt-2">
                    {spot.historicalSales.map((item, idx) => (
                      <div
                        key={idx}
                        className="flex-1 flex flex-col items-center space-y-1.5"
                      >
            ...
            <div className="space-y-6 border-t border-brand-navy/5 pt-8">
              <h3 className="text-xl font-bold text-brand-navy">
                Truck Vendor Reviews
              </h3>
              <div className="space-y-4">
                {spot.reviews.map((review, idx) => (
                  <div
                    key={idx}
                    className="p-5 rounded-2xl bg-white border border-brand-navy/5 shadow-sm space-y-3"
                  >
                ...
                <div>
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    ...
                    >
                      ...
                      <span className="text-[8px] font-normal block font-sans lowercase mt-0.5">
                        10am-3pm
                      </span>
                    </button>
                    <button
            ...
            <div className="p-4 rounded-2xl bg-brand-cream/60 border border-brand-navy/5 flex items-start space-x-3 text-xs font-semibold text-brand-slate shadow-sm">
              ...
              <div>
                <span className="block text-brand-navy font-bold">
                  SpotReserve Trust Guarantee
                </span>
                <span className="block text-[10px] text-brand-slate font-medium leading-relaxed mt-0.5">
                  Full refund if severe weather alert cancels operations, or if
                  utility hookup experiences technical issues.
                </span>
              </div>
            </div>
          </div>
